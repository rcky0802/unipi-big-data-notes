...
memory:
\begin{itemize}
  \item \textbf{I/O-aware design (explicit):} The algorithm models $B$ and the fast
    memory capacity $M$ directly, and manages buffers, data layout, and
    transfers programmatically.
  \item \textbf{Virtual memory and paging (implicit):} The operating system and the
...
\begin{itemize}
  ...
  \item fraction $\alpha$: \texttt{LOAD} or \texttt{STORE} operations;
