...
\begin{itemize}
  \item \textbf{Progettazione I/O-aware (esplicita):} L'algoritmo modella $B$ e la capacità della memoria veloce $M$ in modo diretto, e gestisce buffer, layout dei dati e trasferimenti in modo programmatico.
  \item \textbf{Memoria virtuale e paginazione (implicita):} Il sistema operativo e l'hardware muovono le pagine in modo trasparente utilizzando tabelle delle pagine e politiche di rimpiazzo come le approssimazioni LRU.
\end{itemize}
