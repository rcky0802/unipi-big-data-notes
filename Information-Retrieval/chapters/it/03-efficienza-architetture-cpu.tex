...
\toprule
\textbf{$N$ (elementi)} & \textbf{Dimensione} & \textbf{Livello} & \textbf{\texttt{sum()}} & \textbf{\texttt{sum\_by\_jumping()}} & \textbf{Rallentamento} \\
\midrule
...
\begin{tabular}{l r l}
\toprule
\textbf{Configurazione} & \textbf{Tempo per iterazione} & \textbf{Comportamento del predittore} \\
\midrule
