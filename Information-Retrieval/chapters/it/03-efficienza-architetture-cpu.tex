...
Quando occorre eseguire tale calcolo su due distinti vettori \texttt{V} e \texttt{West}, l'approccio sequenziale (chiamando \texttt{do\_more\_stuff\_4} su \texttt{V} e poi su \texttt{West}) impiega un tempo complessivo pari a $2T$. Se invece si scrive un'unica funzione che elabora entrambi i vettori all'interno della stessa iterazione, alternando le due catene indipendenti:
